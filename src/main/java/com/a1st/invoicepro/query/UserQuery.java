package com.a1st.invoicepro.query;
...
public class UserQuery {
    ...
    public static final String SELECT_USER_BY_ACCOUNT_KEY_QUERY = "SELECT * from Users WHERE id = (SELECT user_id FROM AccountVerifications WHERE url = :url)";
